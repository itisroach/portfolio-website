<template>
    <header class="flex flex-col justify-center items-center">
        <div class="flex flex-col gap-2">
            <div class="text-4xl font-semibold flex gap-1 from-gray-500 to-blue-500 bg-gradient-to-r bg-clip-text text-transparent">
                <p>Hi I'm Amirali Ashoori </p>
                <img width="40" height="40" src="https://raw.githubusercontent.com/hjemmel/hjemmel/master/images/wave.gif" alt="">
            </div>
            <p class="text-grey-400 opacity-70 text-xl">
                Back-End Developer
            </p>
            ...
            <ul class="flex mt-2 pt-4 justify-start items-center w-fit rounded-3xl">
                <li class="hover:opacity-60 pr-4 py-1 rounded-xl transition-all">
                    <a target="_blank" href="https://github.com/itisroach" class="flex flex-col justify-center items-center gap-1">
                ...
                <li class="hover:opacity-60 px-4 py-1 rounded-xl transition-all">
                    <a target="_blank" href="mailto:rouchashoori@gmail.com" class="flex flex-col justify-center items-center gap-1">
                        <img width="30" height="30" src="../assets/icons/email.png" alt="">
                        <p class="text-sm">Email</p>
                    </a>
                </li>
                <li class="hover:opacity-60 px-4 py-1 rounded-xl transition-all">
                    <a target="_blank" href="https://t.me/thisisroach" class="flex flex-col justify-center items-center gap-1">
                ...
                <li class="hover:opacity-60 px-2 py-1 rounded-xl transition-all">
                    <a target="_blank" href="tel:+989140329711" class="flex flex-col justify-center items-center gap-1">
